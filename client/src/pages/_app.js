...
export default function App({ Component, pageProps }) {
  return (
    <main className='flex flex-col justify-center items-center min-h-screen w-full bg-zinc-50'>
      <div className='flex flex-row justify-evenly items-center bg-blue-500 text-white text-center py-5 w-full fixed top-0'>
        <h1 className='text-2xl font-bold mr-5'>
          Tic Tac Toe
          <span className='inline-flex pl-5 cursor-pointer'>
            <Link
              href='https://github.com/christianbmartinez/tic-tac-toe'
              target='_blank'
            >
              <svg
                className='w-4 h-4'
      ...
      <Component {...pageProps} />
      <footer className='py-4 mt-20 first-letter:fixed bottom-0'>
